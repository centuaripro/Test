...
# supplies (food, toys, habitats)

inventory_categories = ("animals", "supplies")
...
pprint(inventory_sub_categories)

sub_category = input("Select from the available sub-categories: "+", ".join (inventory_sub_categories))

# Get the product and quantity for the selceted subcategory
