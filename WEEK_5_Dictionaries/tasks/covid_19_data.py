...
print(f"\n The Country with the highest number of Covid 19 cases is {country} with {highest_active_cases:,} cases")
...
print("**********RATIO OF ACTIVE CASES TO POPULATION*********")
...
country_with_highest_recovery_rate = None
...
for country, data in dataset["countries"].items():
    ...
    if recovery_rate> highest_recovery_rate:
        ...
        country_with_highest_recovery_rate = country

highest_recovery_rate = highest_recovery_rate * 100
print(f"\n Country with highest recovery rate {country_with_highest_recovery_rate} with {highest_recovery_rate:.2f}")
